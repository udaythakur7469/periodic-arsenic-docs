...
const packages = [
  ...
  { pkg: 'arsenic',         name: 'Arsenic',          desc: 'Semantic runtime monitoring for Node.js. 50+ signals, zero dependencies, request-correlated database observability.', category: 'Monitoring', sym: 'As', num: '33', features: ['50+ signals', 'Request correlation', 'Callsite attribution', '6 databases'], accent: 'blue', current: true },
