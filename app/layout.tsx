...
export const metadata: Metadata = {
  ...
  description:
    "Production-grade semantic runtime monitoring for Node.js. 60+ signals, zero dependencies, multi-database support.",
  ...
  openGraph: {
    ...
    description:
      "Production-grade semantic runtime monitoring for Node.js. 60+ signals, zero dependencies, request-correlated database observability.",
    images: [
      {
  ...
  twitter: {
    ...
    description:
      "Production-grade semantic runtime monitoring for Node.js. 60+ signals, zero dependencies.",
    images: ["/og.png"],
  },
};
